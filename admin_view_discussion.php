...
$pages_query=mysql_query("SELECT count('mid') from discussion_forum");
$pages_query1=mysql_query("SELECT * from discussion_forum");
$tot=mysql_num_rows($pages_query1);
$pages=ceil(mysql_result($pages_query, 0)/$per_page);


echo "<h3> TOTAL Message(s): $tot </h3>";
$page= (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
$start= ($page-1)*$per_page;
 
$query=mysql_query("SELECT * from discussion_forum  order by mid DESC limit $start,$per_page");
